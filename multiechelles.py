...
def multiscale(im, mask, L = 2):
    ...
    for k in range(L):
        ...
        Mx, My = 2 * Mx, 2 * My # adaptation of the offsets to the new scale
        ...
        for index_perturbation in range(card_perturbations):
            ...
            for index_neighbor in range(card_neighbors):
                ...
                offsetim = warp(neighim, tempMx, tempMy)
            ...
            data_energy[:, :, index_perturbation] = partial_result + penaltydata(tempMx, tempMy, scaledmask) # sûr ? avec le mx, my ?
    ...
    return warp(im, Mx, My), Mx, My# -*- coding: utf-8 -*-
"""
Created on Wed May 18 13:03:07 2016
